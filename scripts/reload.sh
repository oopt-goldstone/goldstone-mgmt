...
sysrepoctl -s ${OC_YANG_REPO}:${IETF_YANG_REPO} --install ${OC_YANG_REPO}/platform/openconfig-platform-types.yang
sysrepoctl -s ${OC_YANG_REPO}:${IETF_YANG_REPO} --install ${OC_YANG_REPO}/platform/openconfig-platform-port.yang
sysrepoctl -s ${OC_YANG_REPO}:${IETF_YANG_REPO} --install ${OC_YANG_REPO}/platform/openconfig-platform.yang
